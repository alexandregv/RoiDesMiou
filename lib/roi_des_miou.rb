...
# Base module for RoiDesMiou.
module RoiDesMiou
  require_relative 'roi_des_miou/config'

  CONFIG = Config.new

  Dir["#{File.dirname(__FILE__)}/roi_des_miou/*.rb"].each { |file| require file }
  ...
  # See lib/roi_des_miou/commands.rb, lib/roi_des_miou/events.rb and lib/roi_des_miou/permissions.rb
  Permissions.set!
  Commands.include!
  Events.include!
